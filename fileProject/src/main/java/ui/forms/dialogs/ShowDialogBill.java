...
import com.mycompany.fileproject.LocationArchive;
...
public class ShowDialogBill extends javax.swing.JDialog {
    ...
    public ShowDialogBill(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Facturas realizadas");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 380, 280));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            for (int i = 0; i < tableLine.length; i++) {
                ...
                JOptionPane.showMessageDialog(null, "No se puede mostrar la información. No se encuentra el archivo");
            }      
